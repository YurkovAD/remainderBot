...
import com.company.telegram.botTools.BotTask;
 ...
 */
abstract class UserCommand extends BotCommand {

    private BotTask botTask;

    UserCommand(String identifier, String description, BotTask botTask) {
