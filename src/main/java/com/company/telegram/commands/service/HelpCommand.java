    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        sendAnswer(absSender, chat.getId(), this.getCommandIdentifier(), userName,
                ...
                "*Список команд*\n" +
                        ...
                        "/remove - Удалить задание из списка напоминаний\n" +
                        "/list - Получить список заданий на сегодня\n" +
                        "/help - Помощь\n\n" +
                ...
                "list - команда для получения списка заданий, о которых я должен Вам напомнить.\n\n" +
